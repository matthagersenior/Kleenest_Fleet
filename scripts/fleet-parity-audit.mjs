...
'intelligence':['fleet_operations_exception_intelligence','fleet_restroom_preventive_schedule','fleet_restroom_remediation_risk','fleet_restroom_prevention_effectiveness'],
...
console.log('Fleet parity audit passed: access, CRUD, execution, maintenance, Premium, metrics, intelligence, policies, signals and Enterprise surfaces are present.');
