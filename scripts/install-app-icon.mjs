...
if(!fs.statSync(target).size)throw new Error('Fleet app icon decode produced an empty file.');
console.log(`Installed Fleet app icon at ${path.relative(root,target)}.`);
